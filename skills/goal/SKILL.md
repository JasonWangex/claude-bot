...
- **子任务拆解**：拆解到"执行时不需要做判断"的粒度
  ...
  - 代码任务复杂度判断：simple = 改 1-3 文件、有模式可参考；complex = 4+ 文件、需架构设计。默认 simple
  - 代码类子任务注明技术选择
...
- [ ] `[代码, simple]` t1: 子任务描述 — 技术备注
- [ ] `[代码, complex]` t2: 子任务描述 — depends: t1
- [ ] `[调研]` t3: 子任务描述 — depends: t1
- [ ] `[代码, simple]` t4: 子任务描述 — depends: t2, t3
