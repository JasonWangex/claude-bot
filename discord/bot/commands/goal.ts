...
async function handleGoal(
  ...
  if (!newSession) {
    ...
    const prompt = deps.promptService.applyVars(promptTemplate, { THREAD_ID: channelId });
  ...
  try {
    ...
    const prompt = deps.promptService.applyVars(promptTemplate, { THREAD_ID: forkResult.channelId });
